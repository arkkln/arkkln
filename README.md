...
**2016 - Armenian NLP**
- helped build the first open-source Armenian corpora - [github.com/Armtreebank](https://github.com/Armtreebank)
- trained early NLP models at [github.com/YerevaNN](https://github.com/YerevaNN)
